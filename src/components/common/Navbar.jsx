...
{/*           
          <li className="relative">
            ...
            {activeDropdown === 'page' && (
              <div className="absolute top-full mt-2 bg-white shadow-lg rounded-md py-2 min-w-[180px] z-50">
                <Link to="#page1" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">Page 1</Link>
                <Link to="#page2" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">Page 2</Link>
                <Link to="#page3" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">Page 3</Link>
              </div>
            )}
          </li> */}
          ...
          {/* <li className="relative">
            ...
            {activeDropdown === 'blog' && (
              <div className="absolute top-full mt-2 bg-white shadow-lg rounded-md py-2 min-w-[180px] z-50">
                <Link to="#latest" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">Latest Posts</Link>
                <Link to="#categories" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">Categories</Link>
                <Link to="#archive" className="block px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-100 transition-colors">Archive</Link>
              </div>
            )}
          </li> */}
